...
# Moscow region ID = 1, 1-room flat, rent, max 60 000 RUB
def build_query(page: int) -> dict:
    return {
        "jsonQuery": {
            ...
            "price": {"type": "range", "value": {"lte": 60000}},
...
def main():
    log.info("Starting Cian parser — 1-room rentals in Moscow up to 60 000 RUB")
